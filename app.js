...
async function init() {
  const fileMap = {
    ...
    current_events: "data/current_events.json",
    english: "data/english.json",
    mental_ability: "data/mental_ability.json",
    economy: "data/economy.json",
    material_mgmt: "data/material_mgmt.json",
    sample_paper1: "data/sample_paper1.json",
    sample_paper2: "data/sample_paper2.json",
    sample_paper3: "data/sample_paper3.json",
    sample_paper4: "data/sample_paper4.json"
  };
